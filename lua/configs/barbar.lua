...
return {
  ...
  config = function()
    ...
    map('n', '<M-!>',           '<cmd>BufferGoto 1<CR>')
    map('n', '<M-@>',           '<cmd>BufferGoto 2<CR>')
    map('n', '<M-#>',           '<cmd>BufferGoto 3<CR>')
    map('n', '<M-$>',           '<cmd>BufferGoto 4<CR>')
    map('n', '<M-%>',           '<cmd>BufferGoto 5<CR>')
    map('n', '<M-^>',           '<cmd>BufferGoto 6<CR>')
    map('n', '<M-&>',           '<cmd>BufferGoto 7<CR>')
    map('n', '<M-*>',           '<cmd>BufferGoto 8<CR>')
    map('n', '<M-(>',           '<cmd>BufferLast<CR>')
